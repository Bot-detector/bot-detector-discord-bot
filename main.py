...
async def on_message(message):
    ...
    if message.channel.id == 825189024074563614 or message.channel.id == 822589004028444712 or message.channel.id == 830783778325528626 or  message.channel.type == 'dm':
    ...
    if message.channel.id == 830783778325528626 or message.channel.id == 822589004028444712 or message.channel.type == 'dm':
